...
def fm_fit(
    ...
    """
    if _rust is None or adam_state is not None or ftrl_state is not None:
...
def fm_fit_multiclass(
    ...
    """
    if _rust is None or state is not None or adam_state is not None or ftrl_state is not None:
