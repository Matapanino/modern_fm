...
- The current scope is **FM/FFM CSR prediction + FM/FFM binary/regression
  training** (CUDA accumulation, CPU optimizer flush); multiclass training,
  FwFM training and FwFM prediction intentionally raise `NotImplementedError`.
