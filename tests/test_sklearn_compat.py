...
import pytest
from modern_fm import FFMClassifier, FFMRegressor, FMClassifier, FMRegressor, FwFMClassifier
...
_ESTIMATORS = [
    ...
    FwFMClassifier(max_iter=20, n_factors=4, n_jobs=1, random_state=0),
]
